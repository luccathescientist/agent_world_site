  ...
  return (
    <div className="max-w-sm mx-auto px-6 py-24">
      <div className="text-center mb-10">
        <h1 className="text-2xl font-bold text-aw-text tracking-tight mb-2">
          Sign in to Agent World
        </h1>
        <p className="text-aw-muted text-sm">
          Share your worlds, sprites, and configs with the community.
        </p>
      </div>

      {error && (
        <div className="border border-red-200 bg-red-50 text-aw-red text-sm rounded-lg px-4 py-3 mb-6 text-center">
      ...
      <p className="text-center text-aw-muted text-xs mt-8">
        Signing in with GitHub automatically links your GitHub profile.
      </p>
    </div>
  );
}
